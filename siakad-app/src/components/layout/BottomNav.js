...
export default function BottomNav() {
  ...
  return (
    <nav className="md:hidden fixed bottom-6 left-1/2 -translate-x-1/2 w-[85%] max-w-[320px] z-50">
      <div className="bg-white/70 dark:bg-slate-900/70 backdrop-blur-2xl border border-white/40 dark:border-white/10 shadow-xl shadow-slate-200/50 dark:shadow-black/50 rounded-full px-8 py-2.5 flex items-center justify-between relative">
        ...
        <div className="relative -top-4">
          <Link 
            href="/dashboard"
            className="flex flex-col items-center justify-center w-12 h-12 rounded-full bg-gradient-to-br from-emerald-500 to-teal-600 dark:from-emerald-600 dark:to-teal-700 shadow-lg shadow-emerald-500/30 text-white hover:scale-105 active:scale-95 transition-all duration-300 border-[3px] border-slate-50 dark:border-slate-950"
          >
